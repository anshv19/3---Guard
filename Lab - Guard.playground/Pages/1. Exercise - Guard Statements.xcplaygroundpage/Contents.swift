...
if let positive = calculateArea(x: 15, y: 20) {
    print("Area: \(positive)")
} else {
    print("Invalid")
}

if let negative = calculateArea(x: -15, y: 30) {
    print("Area: \(negative)")
} else {
    print("Invalid input")
}
...
func add(_ num1: Int?, _ num2: Int?) -> Int? {
    guard let Num1 = num1, let Num2 = num2
...
if let result1 = add(25, 30) {
    print("Result: \(result1)")
} else {
    print("Invalid")
}

if let result2 = add(35, nil) {
...
lastNameTextField.text = "Shelby"
ageTextField.text = "45"
